        ...
        <div class="account-page">
			<div class="account-center">
				<div class="account-box">  
                    ...
                    <form action="<?php echo base_url('user/checkLogin2');?>" class="form-signin" method="post">  
                        <?php 
                    ...
                    <form action="<?php echo base_url('user/register/0');?>" class="form-signin" method="post">                                         
                      <a href="<?php echo base_url('user/register/0');?>"><font color="Blue">Register Here..</a></font>   
                    </form> 
                    </div>
			</div>
        </div>                    
